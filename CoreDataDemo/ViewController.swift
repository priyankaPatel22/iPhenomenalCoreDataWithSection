...
class ViewController: UIViewController {
   ...
   // var dataArray:NSMutableArray!
    ...
    fileprivate lazy var fetchedResultsController: NSFetchedResultsController<Employee> = {
        ...
        fetchRequest.sortDescriptors = [NSSortDescriptor(key: #keyPath(Employee.name), ascending: true)]

        // Create Fetched Results Controller
        let fetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: AppDelegate.appDelegate.persistentContainer.viewContext, sectionNameKeyPath: #keyPath(Employee.city), cacheName: nil)
